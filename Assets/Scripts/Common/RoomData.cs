...
public static class RoomData
{
    ...
    static RoomData()
    {
        roomData = new Dictionary<int, Data>()
        {
            ...
            { 11, new Data(new Vector2(0f, 0f), 0, "JUST GIVE UP... IT KEEPS GETTING HARDER." ) },
            { 12, new Data(new Vector2(0f, 0f), 0, "I HOPE YOU'RE NOT IN A HURRY." ) },
            { 13, new Data(new Vector2(0f, 0f), 0, "THIS IS WAY TOO EASY.\nSERIOUSLY. NOT HARD." ) },
            { 14, new Data(new Vector2(0f, 0f), 0, "IT STARTS TO GET REAL TRICKY HERE." ) },
            { 15, new Data(new Vector2(0f, 0f), 0, "THERE'S AN EASY WAY AND A HARD WAY." ) },
            { 16, new Data(new Vector2(0f, 0f), 0, "GIVE UP, THIS ONE ISN'T EVEN HARD." ) },
            { 17, new Data(new Vector2(0f, 0f), 0, "YOU WON'T BEAT THE GAME." ) },
            { 18, new Data(new Vector2(0f, 0f), 0, "THIS ONE IS SO HARD YOU'LL NEVER DO IT." ) },
